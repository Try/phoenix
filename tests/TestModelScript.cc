...
TEST_SUITE("ModelScript") {
	TEST_CASE("ModelScript(parse:?)") {
		...
		CHECK_EQ(script.animations[0].flags, (phoenix::AnimationFlags::MOVE | phoenix::AnimationFlags::IDLE));
		CHECK_EQ(script.animations[0].model, "aniModel1");
		CHECK_EQ(script.animations[0].direction, phoenix::AnimationDirection::FORWARD);
		...
		CHECK_EQ(script.animations[1].flags, phoenix::AnimationFlags::MOVE);
		CHECK_EQ(script.animations[1].model, "aniModel2");
		CHECK_EQ(script.animations[1].direction, phoenix::AnimationDirection::BACKWARD);
		...
		CHECK_EQ(script.animations[1].events[0].type, phoenix::MdsEventType::TORCH_DROP);
		CHECK_EQ(script.animations[1].events[0].attached, true);
		CHECK_EQ(script.animations[1].events[1].frame, 1);
		CHECK_EQ(script.animations[1].events[1].type, phoenix::MdsEventType::COMBO_WINDOW);
		...
		CHECK_EQ(script.animations[1].events[2].type, phoenix::MdsEventType::ITEM_CREATE);
		...
		CHECK_EQ(script.aliases[0].flags, (phoenix::AnimationFlags::ROTATE | phoenix::AnimationFlags::QUEUE));
		CHECK_EQ(script.aliases[0].alias, "aliasAlias1");
		CHECK_EQ(script.aliases[0].direction, phoenix::AnimationDirection::FORWARD);
		...
		CHECK_EQ(script.aliases[1].flags, phoenix::AnimationFlags::FLY);
		CHECK_EQ(script.aliases[1].alias, "aliasAlias2");
		CHECK_EQ(script.aliases[1].direction, phoenix::AnimationDirection::BACKWARD);
		...
		CHECK_EQ(script.combinations[0].flags, phoenix::AnimationFlags::MOVE);
		...
		CHECK_EQ(script.combinations[1].flags, phoenix::AnimationFlags::IDLE);
	...
	TEST_CASE("ModelScript(parse:?/binary") {
		...
		CHECK_EQ(script.animations[0].flags, phoenix::AnimationFlags::MOVE);
		...
		CHECK_EQ(script.aliases[0].flags, (phoenix::AnimationFlags::MOVE | phoenix::AnimationFlags::IDLE));
		...
		CHECK_EQ(script.animations[47].events[3].type, phoenix::MdsEventType::COMBO_WINDOW);
	...
	TEST_CASE("ModelScript(parse:g1)" * doctest::skip()) {
		// TODO: Stub
	}

	TEST_CASE("ModelScript(parse:g1/binary)" * doctest::skip()) {
		// TODO: Stub
	}

	TEST_CASE("ModelScript(parse:g2)" * doctest::skip()) {
		// TODO: Stub
	}

	TEST_CASE("ModelScript(parse:g2/binary)" * doctest::skip()) {
		// TODO: Stub
	}
}
