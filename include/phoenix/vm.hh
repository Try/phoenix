...
namespace phoenix {
	...
	public:
		PHOENIX_API DaedalusIllegalExternalDefinition(const DaedalusSymbol* sym, std::string&& message);
	...
	public:
		PHOENIX_API DaedalusIllegalExternalReturnType(const DaedalusSymbol* sym, std::string&& provided);
	};
	...
	public:
		PHOENIX_API DaedalusIllegalExternalParameter(const DaedalusSymbol* sym, std::string&& provided, std::uint8_t i);
	};
	...
	enum class DaedalusVmExceptionStrategy {
		...
		// Deprecated entries.
		continue_ PHOENIX_DEPRECATED("renamed to DaedalusVmExceptionStrategy::CONTINUE") = CONTINUE,
		return_ PHOENIX_DEPRECATED("renamed to DaedalusVmExceptionStrategy::RETURN") = RETURN,
		fail_ PHOENIX_DEPRECATED("renamed to DaedalusVmExceptionStrategy::FAIL") = FAIL,
	};
	...
	namespace DaedalusVmExecutionFlag {
		...
		// Deprecated entries.
		PHOENIX_DEPRECATED("renamed to DaedalusVmExecutionFlag::NONE") static constexpr std::uint8_t none = NONE;

		PHOENIX_DEPRECATED("renamed to DaedalusVmExecutionFlag::ALLOW_NULL_INSTANCE_ACCESS")
		static constexpr std::uint8_t vm_allow_null_instance_access = ALLOW_NULL_INSTANCE_ACCESS;

		PHOENIX_DEPRECATED("renamed to DaedalusVmExecutionFlag::IGNORE_CONST_SPECIFIER")
	...
	public:
		...
		PHOENIX_API explicit DaedalusVm(DaedalusScript&& scr, uint8_t flags = DaedalusVmExecutionFlag::NONE);
		...
		PHOENIX_API void push_instance(std::shared_ptr<DaedalusInstance> value);
		PHOENIX_API void push_reference(DaedalusSymbol* value, std::uint8_t index = 0);
		...
		[[nodiscard]] PHOENIX_API std::shared_ptr<DaedalusInstance> pop_instance();
		[[nodiscard]] PHOENIX_API const std::string& pop_string();
		[[nodiscard]] PHOENIX_API std::tuple<DaedalusSymbol*, std::uint8_t, std::shared_ptr<DaedalusInstance>>
		pop_reference();
		...
		PHOENIX_API void
		register_default_external_custom(const std::function<void(DaedalusVm&, DaedalusSymbol&)>& callback);
	...
	protected:
		...
		PHOENIX_INTERNAL void push_call(const DaedalusSymbol* sym);
	...
	PHOENIX_API DaedalusVmExceptionStrategy lenient_vm_exception_handler(DaedalusVm& v,
	                                                                     const DaedalusScriptError& exc,
	                                                                     const DaedalusInstruction& instr);

	using illegal_external_definition
	    PHOENIX_DEPRECATED("renamed to DaedalusIllegalExternalDefinition") = DaedalusIllegalExternalDefinition;
	using illegal_external_rtype
	    PHOENIX_DEPRECATED("renamed to DaedalusIllegalExternalReturnType") = DaedalusIllegalExternalReturnType;
	using illegal_external_param
	    PHOENIX_DEPRECATED("renamed to DaedalusIllegalExternalParameter") = DaedalusIllegalExternalParameter;
	using vm_exception PHOENIX_DEPRECATED("renamed to DaedalusVmException") = DaedalusVmException;
	using vm_exception_strategy
	    PHOENIX_DEPRECATED("renamed to DaedalusVmExceptionStrategy") = DaedalusVmExceptionStrategy;
	using daedalus_stack_frame PHOENIX_DEPRECATED("renamed to DaedalusStackFrame") = DaedalusStackFrame;
	using daedalus_call_stack_frame PHOENIX_DEPRECATED("renamed to DaedalusCallStackFrame") = DaedalusCallStackFrame;
	namespace execution_flag = DaedalusVmExecutionFlag;
	using vm PHOENIX_DEPRECATED("renamed to DaedalusVm") = DaedalusVm;
} // namespace phoenix
